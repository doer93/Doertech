...
function kopa_comment_callback($comment, $args, $depth) {
    ...
    ?>
    <li <?php comment_class(); ?> id="li-comment-<?php echo get_comment_ID() ?>">   


        <article id="comment-<?php echo get_comment_ID(); ?>" class="comment-wrap clearfix">
            ...
            <div class="comment-body clearfix">
                <div class="comment-meta">
                    ...
                    if ('approved' != $status) {
                        ?>
                        <span><i><?php _e('(Your Comment is Under Moderation)', kopa_get_domain()); ?></i></span>
                        <?php
                    }
                    ?>
